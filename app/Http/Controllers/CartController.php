...
class CartController extends Controller
{
    ...
    public function addToCart(Request $request){
        ...
        if($already_cart) {
            ...
            /*DB::table('products')
            ->where('id', $product->id)
            ->update(array('stock' => $product->stock-1));*/
            Product::find($product->id)->decrement('stock',1);
            $already_cart->save();
    ...
    public function singleAddToCart(Request $request){
        ...
        if($already_cart) {
            ...
            DB::table('products')
            ->where('id', $product->id)
            ->update(array('stock' => $product->stock-$request->quant[1]));
            $already_cart->save();
    ...
    public function cartDelete(Request $request){
        ...
        if ($cart) {
            $cart->delete();
            Product::find($cart->product_id)->increment('stock',$cart->quantity);
