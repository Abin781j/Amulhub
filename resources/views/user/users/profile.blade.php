            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body mt-4 ml-2">
                      ...
                      <p class="card-text text-left"><small><i class="fas fa-phone"></i> {{$profile->phone}}</small></p>
                      <p class="card-text text-left"><small><i class="fas fa-store"></i> {{$profile->sname}}</small></p>
                ...
                <form class="border px-4 pt-2 pb-3" method="POST" action="{{route('user-profile-update',$profile->id)}}">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input id="inputEmail" type="number" name="phone" placeholder="Enter phone number"  value="{{$profile->phone}}" class="form-control">
                        @error('phone')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                      </div>
                      ...
                      <div class="form-group">
                        <label for="inputlicence" class="col-form-label">Licence Number</label>
                        <input id="inputLicence" type="text" name="licence" placeholder="Enter phone Licence"  value="{{$profile->licence}}" class="form-control">
                        @error('sname')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                      </div>
