...
@section('title','AMULHUB || Register Page')
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="sname" placeholder="" required="required" value="{{old('sname')}}">
                                        @error('sname')
                                            <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label>Shop Registration number<span>*</span></label>
                                        <input type="text" name="licence" placeholder="" required="required" value="{{old('licence')}}">
                                        @error('licence')
                                            <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="phone" placeholder="" required="required" value="{{old('phone')}}">
                                        @error('phone')
                                            <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
